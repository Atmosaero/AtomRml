 ...
 */
#include "AtomRmlConsoleDocument.h"
...
namespace AtomRml
{
    bool AtomRmlConsoleDocument::Initialize(Rml::Context* ctx, const char* rmlPath)
    {
    ...
    AtomRmlConsoleDocument::~AtomRmlConsoleDocument()
    {
    ...
    bool AtomRmlConsoleDocument::OnPreError(const char* window, const char*, int,
    ...
    bool AtomRmlConsoleDocument::OnPreWarning(const char* window, const char*, int,
                                             const char*, const char* message)
    {
    ...
    bool AtomRmlConsoleDocument::OnPrintf(const char* window, const char* message)
    {
        AddLog(window, message, AZ::LogLevel::Notice);
        return false;
    }

    void AtomRmlConsoleDocument::OnSystemTick()
    {
        UpdateLogElements();
    }

    void AtomRmlConsoleDocument::ProcessEvent(Rml::Event& event)
    {
    ...
    void AtomRmlConsoleDocument::OnCommandInput(const AZStd::string& command)
    {
        if (command.empty())
        {
            return;
    ...
    void AtomRmlConsoleDocument::OnClearLogs() const
    {
    ...
    void AtomRmlConsoleDocument::OnHistoryUp()
    {
    ...
    void AtomRmlConsoleDocument::OnHistoryDown()
    {
    ...
    void AtomRmlConsoleDocument::OnAutoComplete(const AZStd::string& partial) const
    {
        AZ::IConsole* console = AZ::Interface<AZ::IConsole>::Get();
    ...
    void AtomRmlConsoleDocument::SetupEventListeners()
    {
    ...
    void AtomRmlConsoleDocument::FocusInput() const
    {
        Rml::Element* inputElement = m_doc->GetElementById("console_input");
        if (inputElement)
        {
    ...
    void AtomRmlConsoleDocument::ScrollToBottom() const
    {
    ...
    void AtomRmlConsoleDocument::SetInputText(const AZStd::string& text) const
    {
        Rml::Element* inputElement = m_doc->GetElementById("console_input");
        if (inputElement)
        {
            ...
            {
                const int selectionPosition = aznumeric_cast<int>(text.size());
                i->SetSelectionRange(selectionPosition, selectionPosition);
            }
        }
    }

    AZStd::string AtomRmlConsoleDocument::GetInputText() const
    {
        Rml::Element* inputElement = m_doc->GetElementById("console_input");
        if (inputElement)
        {
    ...
    AZ::Color AtomRmlConsoleDocument::GetColorForLogLevel(AZ::LogLevel level)
    {
        switch (level)
        {
    ...
    void AtomRmlConsoleDocument::AddLog(const char* window, const char* message, AZ::LogLevel level)
    {
    ...
    void AtomRmlConsoleDocument::UpdateLogElements()
    {
